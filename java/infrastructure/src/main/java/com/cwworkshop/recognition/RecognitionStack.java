...
// java RecognitionStack class that extends Stack class.
// This class defines the Recognition stack.
// The Recognition stack contains the following:
// - IAM group and user to grant Rekognition permissions
// - DynamoDB table to store Rekognition results
// - Lambda function to perform Rekognition on images
...
// - Lambda function policy to allow the Lambda function to read from the DynamoDB table
// - Lambda function policy to allow the Lambda function to write to the DynamoDB table
